...
use eRecept\Request\LoadVersionsRequest;
use eRecept\Response\NacistVerzeResponse;

class LoadVersionsFunctionTest extends FunctionTest
{
	...
	public function testClient()
	{
		...
		$response = $this->getClient()->send(new LoadVersionsRequest($messageEntity));

		$this->assertInstanceOf(NacistVerzeResponse::class, $response);
